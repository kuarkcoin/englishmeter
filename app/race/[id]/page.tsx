...
                START RACE
            </button>
            {/* KALDIRILDI: <Link href="/" className="text-gray-400 hover:text-gray-600 text-sm font-medium mt-2"> ← Select Another Race </Link> */}
          </div>
        </div>
      </main>
    );
...
                </button>
                
                {/* KALDIRILDI: <Link href="/" className="w-full bg-blue-100 text-blue-700 py-4 rounded-xl font-bold hover:bg-blue-200 transition flex items-center justify-center gap-2"> ⬅️ Race Menu </Link> */}
            </div>
            </div>
        </div>
      </main>
